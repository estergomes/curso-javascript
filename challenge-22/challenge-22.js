  ...
  (function(){
    ...
    */
    function sum(){
      ...
      function(accumulated, atualItem){
        return +accumulated + +atualItem;
      });
    }
    ...
    */
    var userEntry = prompt('Entre com alguns números que serão somados: ',0);
    ...
    */
    ...
    console.log(justNumbers('a5a6a7a8a9'));
